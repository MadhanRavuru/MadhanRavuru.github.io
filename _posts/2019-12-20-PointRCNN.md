...
$$\tilde{\mathbf{b}}_{i}$$ and $$\tilde{\mathbf{b}}_{i}^{\mathrm{gt}}$$
Finally, oriented NMS with BEV IoU threshold 0.01 is applied to remove the overlapping bounding boxes and generate the 3D refined bounding boxes.
